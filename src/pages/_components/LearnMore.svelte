<script lang="ts">
  ...
  import ranRocket from "@assets/images/ran/ran-icon-bgblack.png"
</script>

{#if $typewriterFinished}
  <div class="flex flex-col items-center justify-center text-white">
    <a href="https://ran.so" target="_blank" class="relative inline-flex h-32 w-32 overflow-hidden rounded-full p-[2px] hover:outline-none hover:ring-2 hover:ring-slate-400 hover:ring-offset-2 hover:ring-offset-slate-50">
      ...
      <span class="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 text-sm font-medium text-white backdrop-blur-3xl">
        <img src={ranRocket.src} alt="RAN Icon" class="rounded-full h-fit w-fit" />
      </span>
    </a>
